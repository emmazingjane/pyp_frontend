...
// You need to install and impot axios for API calls (restart server after install)
...
class SingleLiquorType extends Component {
    ...
    componentDidMount() {
        let liquorRecipeId = this.props.match.params.liquor_id;
        // findRecipes has not been defined in CocktailModel yet, commented out to prevent error
    ...
    render(){
        ...
        let results = this.state.results !== null
                                ...
                                <div className="card horizontal">
                                    ...
                                    <div className="card-stacked">
                                        ...
                                        <div className="card-action">
                                            ...
                                            <div className="rate">
                                                <button onClick={()=>this.incrementVote         (liquorRecipes._id)} className="btn-floating       btn-small waves-effect waves-light             green"><i className="material-icons">        +</i></button>
                                                    {/* <a href="./single_recip.html">rate me</a> */}
                                                    <button onClick={()=>this.decrementVote(liquorRecipes._id)} className="btn-floating btn-small waves-effect waves-light red"><i className="material-icons">-</i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            : <h3>Loading...</h3>; {/* MISSING THE ELSE FOR THE TERNARY STATEMENT ABOVE */}
